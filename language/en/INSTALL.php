...
// 2Moons - Copyright (C) 2010-2017 mvw
...
$LNG['intro_text']				= 'The 2Moons project is one of the best OGame style games.<br>2Moons is one of the newest Opensource projects currently developed. 2Moons is known for its ease of stability, flexibility, dynamism, quality and utilization. we always expect to be better than your expectations.<br><br>This installation system will guide you through the installation or upgrading from a previous version of 2Moons. For questions, problems, please ask our development or support teams for assistance!<br><br>2Moons is an Open Source project, licensed under the GNU GPL v3. For this to be verified, please click the link above where it refers to "lincense"<br><br>For installation to begin we must conduct a small test to see if your server has all the requirements to support the 2Moons engine';
$LNG['intro_upgrade_head'] = '2Moons already installed?';
$LNG['intro_upgrade_text'] = '<p>You have already installed 2Moons and want to easily update?</p><p>You can update your old database with just a few clicks!</p>';


$LNG['upgrade_success']		    = 'Update of the database successful. Database is now at revision %s.';
$LNG['upgrade_nothingtodo']	  = 'No action is required. Database is already up to revision %s.';
$LNG['upgrade_back']			    = 'Back';
$LNG['upgrade_intro_welcome']	= 'Welcome to the 2Moons Database Upgrader!';
...
$LNG['licence_need_accept']	 = 'If you want to continue with the installation, you will need to accept the terms of license';

$LNG['req_head']				    = 'System requirements';
$LNG['req_desc']				    = 'Before the installation can proceed, 2Moons will need to conduct tests to verify that your server supports the 2Moons, so to ensure that the 2Moons engine can be installed. It is suggested that you read the results carefully, and <strong>do not proceed</strong> until all these have been checked.';
$LNG['reg_yes']					    = 'Yes';
$LNG['reg_no']					    = 'No';
$LNG['reg_found']				    = 'Found';
...
$LNG['req_php_need_desc']		= '<strong>Required</strong> — PHP is the language code base of 2Moons. This is the required PHP version 5.6 or higher so that all modules work correctly. PHP 7.0+ is reccomended';
$LNG['reg_gd_need']				  = 'Installed version of the GD PHP Script &raquo;gdlib&laquo;';
$LNG['reg_gd_desc']				  = '<strong>Optional</strong> — Graphic Processing Library &raquo;gdlib&laquo; Is responsible for the generation of dynamic images. They may not work without some of the features of the software.';
...
$LNG['req_ftp_head']			  = 'Insert information of host / FTP / SSH';
$LNG['req_ftp_desc']			  = 'Input your FTP Information so 2Moons can automatically fix problems. Alternatively, you can also manually assign permissions to write.';
...
$LNG['req_ftp_error_data']	= 'The information provided was not allowed to connect to the server, so this link failed, please check your details';
$LNG['req_ftp_error_dir']		= 'The directory you entered is invalid or does not exist';
$LNG['reg_pdo_active']			= 'Support &raquo;PDO&laquo; Extension';
$LNG['reg_pdo_desc']			  = '<strong>Prerequisites</strong> — You need to provide support for PDO in PHP.';

$LNG['step1_head']				  = 'Configure installation Database';
$LNG['step1_desc']				  = 'Now that it has been determined that 2Moons can be installed on your server, s should provide some information. If you dont know how to run a database, contact your hosting provider first or with the 2Moons forum for help and support. When you insert the data, checks were introduced properly';
...
$LNG['step2_db_con_fail']		 = 'There is an error in the database link. The details will be displayed below';
$LNG['step2_conf_op_fail']	 = "config.php can't be written to!";
...
$LNG['step3_desc']				   = 'The tables needed for the 2Moons database have been created and populated with default values. Conclude the installation of 2Moons by clicking on next';
...
$LNG['step4_admin_name']		  = 'User name of Administrator:';
$LNG['step4_admin_name_desc']	= 'Type the name to use with the length of 3 to 20 characters';
$LNG['step4_admin_pass']		  = 'Password for Game Administrator:';
$LNG['step4_admin_pass_desc']	= 'Type a password with a length of 8 to 30 characters';
$LNG['step4_admin_mail']		  = 'Contact E-mail:';

$LNG['step6_head']				    = 'Installation completed!';
$LNG['step6_desc']				    = 'You\'ve successfully installed the 2Moons engine system';
$LNG['step6_info_head']			  = 'Start using the 2Moons engine!';
...
$LNG['step8_need_fields']		  = 'You must fill in all required fields.';
